...
,`TABLE_CATALOG` varchar(0)
,`TABLE_SCHEMA` varbinary(0)
,`TABLE_NAME` varbinary(0)
,`LOGFILE_GROUP_NAME` varchar(256)
,`LOGFILE_GROUP_NUMBER` bigint
,`ENGINE` varchar(64)
,`FULLTEXT_KEYS` varbinary(0)
,`DELETED_ROWS` varbinary(0)
,`UPDATE_COUNT` varbinary(0)
,`FREE_EXTENTS` bigint
...
,`CREATION_TIME` varbinary(0)
,`LAST_UPDATE_TIME` varbinary(0)
,`LAST_ACCESS_TIME` varbinary(0)
,`RECOVER_TIME` varbinary(0)
,`TRANSACTION_COUNTER` varbinary(0)
,`VERSION` bigint
,`ROW_FORMAT` varchar(256)
,`TABLE_ROWS` varbinary(0)
,`AVG_ROW_LENGTH` varbinary(0)
,`DATA_LENGTH` varbinary(0)
,`MAX_DATA_LENGTH` varbinary(0)
,`INDEX_LENGTH` varbinary(0)
,`DATA_FREE` bigint
,`CREATE_TIME` varbinary(0)
,`UPDATE_TIME` varbinary(0)
,`CHECK_TIME` varbinary(0)
,`CHECKSUM` varbinary(0)
,`STATUS` varchar(256)
,`EXTRA` varchar(256)
);
...
,`ACTION_CONDITION` varbinary(0)
,`ACTION_STATEMENT` longtext
,`ACTION_ORIENTATION` varchar(3)
,`ACTION_TIMING` enum('BEFORE','AFTER')
,`ACTION_REFERENCE_OLD_TABLE` varbinary(0)
,`ACTION_REFERENCE_NEW_TABLE` varbinary(0)
